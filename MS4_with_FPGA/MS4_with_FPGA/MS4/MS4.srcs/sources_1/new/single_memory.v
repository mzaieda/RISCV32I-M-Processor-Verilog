...
reg [7:0] mem [(64-1):0]; //Byte addressable memory (1 GB elemetns each elemtns contains 8 bits)
reg [31:0] my_data, my_instr;
wire [31:0] base = 32; //base of data memory
//fetch instruction at pos edge and access data at neg edge

initial begin
$readmemh("instructions_mem.mem", mem);
//{mem[3],mem[3],mem[2],mem[1]}=32'h00000033;
	mem[0+base]=8'b00000011;  
	mem[1+base]=8'b00000000;
	mem[2+base]=8'b00000000;
	mem[3+base]=8'b00000001;
	mem[4+base]=8'b00001010;
	mem[5+base]=8'b00000000;
...
muxarray choose_data(my_instr, my_data, slower_clock, data_out);
