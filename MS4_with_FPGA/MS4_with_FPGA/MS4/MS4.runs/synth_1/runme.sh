...
HD_PWD='C:/Users/CSE.CAL/Desktop/MS4_with_FPGA/MS4_with_FPGA/MS4/MS4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RISCVHandler.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RISCVHandler.tcl
