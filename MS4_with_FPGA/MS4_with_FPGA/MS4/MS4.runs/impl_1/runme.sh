...
HD_PWD='C:/Users/CSE.CAL/Desktop/MS4_with_FPGA/MS4_with_FPGA/MS4/MS4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RISCVHandler.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RISCVHandler.tcl -notrace
